...
if (isset($_POST['submit'])) {
    ...
    $email = mysqli_real_escape_string($conn, $_POST['email']);
     ...
     $users = mysqli_query($conn, "SELECT * FROM `users` WHERE email = '$email'") or die('query failed');
    if (mysqli_num_rows($users) > 0) {
        $row = mysqli_fetch_assoc($users);
        $id = $row['user_id'];
        header('location: password-forget-form.php?user_id='.$id.'');
    }else {
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <div class="container text-center py-5">
                <h1 class="display-2 text-white mb-4 animated slideInDown">Password Recovery</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center mb-0 animated slideInDown">
                        ...
                        <li class="breadcrumb-item text-white" aria-current="page">Password Recovery</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-fluid py-5" id="Login">
            <div class="container py-5">
                <div class="text-center mb-5 wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <h1 class="display-5 w-50 mx-auto">Password Recovery</h1>
                </div>
                <div class="row g-5 mb-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".5s" >
                        <div class="login-box rounded" style="height:500px;border: 2px solid #61c3df; border-radius: 15px; box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1); padding: 30px; background-color: #f9f9f9; transition: transform 0.3s ease;">
                            <!-- Username Field -->
                            <h2 style="margin-bottom: 100px">Password Recovery </h2>
                            <?php
                            if (isset($message)) {
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <input  class="btn border-0 py-3 px-4 rounded-pill" style="background: #61c3df; color: #ffffff;" id="submitButton" value="Send" name="submit" type="submit">

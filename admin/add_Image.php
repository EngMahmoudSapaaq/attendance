...
if (isset($_POST['submit'])) {
   ...
   $image_tmp_name = $_FILES['fileInput']['tmp_name'];
   $image_folder = 'img/'.$image;
    $insert = mysqli_query($conn, "INSERT INTO `facial_images`(user_id,image_path, admin_id)"
            . " VALUES('$user_id','$image','$admin_id')") or die('query failed');
                            ...
                            <div class="card-body p-0" style="width: 700px;margin-left: 300px">
                                ...
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Add User Image!</h1>
                                     <?php
                                        if (isset($message)) {
                                     ...
                                     <form method="post" enctype="multipart/form-data">
                                        ...
                                        <hr>
                                        <label for="fileInput" class="text-primary">Image:</label>

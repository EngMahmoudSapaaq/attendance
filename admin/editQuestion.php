...
$faqs = mysqli_query($conn, "SELECT * FROM `faqs` WHERE faqs_id = '$faqs_id'") or die('Query failed: ' . mysqli_error($conn));
...
$faqs_id = $_GET['faqs_id'] ?? null;
   ...
   $update_query = "UPDATE `faqs` SET `Question` = '$question' , `Answer` = '$Answer'"
                                ...
                                <div class="p-5">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                         ...
                                         <div class="form-floating mb-3">
                                            ...
                                            <textarea class="form-control" id="message" value="<?php echo $faq['Question'];  ?>" name="question" type="text" placeholder="Enter your Question here..." style="height: 10rem" 
                                                       required></textarea>
                                        ...
                                        <hr>
                                         <div class="form-floating mb-3">
                                            ...
                                            <textarea class="form-control" id="message" value="<?php echo $faq['Answer'];  ?>" name="Answer" type="text" placeholder="Enter your Answer here..." style="height: 10rem"  required></textarea>

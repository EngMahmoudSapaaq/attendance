...
$facial_images = mysqli_query($conn, "SELECT * FROM `facial_images` WHERE user_id = '$user_id'") or die('Query failed: ' . mysqli_error($conn));

if (isset($_GET['delete_id'])) {

    $delete_id = $_GET['delete_id'] ?? null;
    mysqli_query($conn, "DELETE FROM facial_images WHERE image_id = '$delete_id'");
    header('location:viewPhotos.php?user_id=' . $user_id . '');
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="add-course-container" style="width: 130px;margin-left: 1100px">
                            <a href="add_Image.php?user_id=<?php echo $user_id;   ?>" class="add-course-btn" style="color: white;text-decoration: none;" name="add">
                                ...
                                <div class="table-responsive">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php
                                                if (isset($facial_images) && mysqli_num_rows($facial_images) > 0) {
                                                    while ($facial_image = mysqli_fetch_assoc($facial_images)) {
                                                        $path = 'img/' . $facial_image['image_path'];
                                                        $user_id = $facial_image['user_id'];
                                                        echo ' <tr>
                                                    <td > <img class="img-profile rounded-circle" style="width:120px;height: 100px;object-fit: cover;" src="' . $path . '"></td>
                                                    
                                                    
                                                     <td class="text-center">
                                                        <a class="btn" href="viewPhotos.php?user_id=' . $user_id . '&&delete_id=' . $facial_image['image_id'] . '" style="background: red;color: white"><img src="img/icons/bin (1).png" style="width: 15px;height: 15px;margin-right: 5px"></a>

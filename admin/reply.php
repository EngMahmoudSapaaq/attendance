...
$message_id = $_GET['message_id'] ?? null;
   ...
   $update_query = "UPDATE `complaints_suggestions` SET `response_text` = '$reply'"
                                ...
                                <div class="p-5">
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <textarea class="form-control" id="message" name="reply" type="text" placeholder="Enter your reply here..." style="height: 10rem" data-sb-validations="required" required=""></textarea>

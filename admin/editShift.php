...
$editShift_id = $_GET['editShift_id'] ?? null;
$shifts = mysqli_query($conn, "SELECT * FROM `shifts` WHERE shift_id = '$editShift_id'") or die('Query failed: ' . mysqli_error($conn));
...
if (isset($_POST['submit'])) {
    ...
    $update_query = "UPDATE `shifts` SET `Day` = '$Day', `Name` = '$shiftName', `Attendance` = '$attendanceTime', `Dismissal` = '$dismissalTime'"
            . " WHERE `shift_id` = '$editShift_id'";
                            ...
                            <div class="card-body p-0" style="width: 700px;margin-left: 300px">
                                ...
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Edit Work Shifts!</h1>
                                         <?php
                                        if (isset($message)) {
                                    ...
                                    <form method="post" enctype="multipart/form-data">
                                        <div class="form-group mb-3" name="shift_Day[]">
                                            ...
                                            <select class="form-control" id="daySelect" name="shift_Day[]"   required>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="shiftName" class="form-control" value="<?php
                                            echo $shift['Name'] ?? null;
                                            ;
                                            ?>" id="shiftName" name="shiftName" placeholder="Enter shift name" required>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="time" name="attendanceTime" class="form-control" value="<?php
                                            echo $shift['Attendance'] ?? null;
                                            ;
                                            ?>" id="attendanceTime" name="attendanceTime" required>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="time" name="dismissalTime" class="form-control" id="dismissalTime" value="<?php
                                            echo $shift['Dismissal'] ?? null;
                                            ;
                                            ?>" name="dismissalTime" required>
                                        ...
                                        <button class="btn" style="background: #006079;color: white" name="submit" type="submit">
                                            <img src="../admin/img/icons/edit (1).png" style="width: 15px;height: 15px;"> edit Shift
                                        </button>

...
if (isset($_POST['submit'])) {
    ...
    if ($type == 'employee') {
        if (mysqli_num_rows($users) > 0) {
            ...
            $insert = mysqli_query($conn, "INSERT INTO `users`(username,password, email,phone,shift_id,allowed_Delay)"
                    . " VALUES('$name','$password', '$email','$phone',$shift,$Delay)") or die('query failed');
        ...
        if (mysqli_num_rows($supervisors) > 0) {
            ...
            $insert = mysqli_query($conn, "INSERT INTO `supervisors`(name, email,password,phone)"

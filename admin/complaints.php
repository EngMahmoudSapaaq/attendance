...
$complaints_suggestions = mysqli_query($conn, "SELECT * FROM `complaints_suggestions` WHERE admin_id = '$admin_id'") or die('Query failed: ' . mysqli_error($conn));
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800"><img src="img/risk.png" style="width: 30px;height: 30px">  complaints</h1>
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            if (isset($complaints_suggestions) && mysqli_num_rows($complaints_suggestions) > 0) {
                                                while ($complaint = mysqli_fetch_assoc($complaints_suggestions)) {
                                                    ...
                                                    $supervisor_id=$complaint['supervisor_id'];
                                                ...
                                                echo ' <td>complaint : .... <div class="dropdown no-arrow">
                                                    ...
                                                    <td class="text-center">
                                                        <a class="btn" href="reply.php?message_id='.$complaint['message_id'].'" style="background: #006079;color: white"><img src="img/reply.png" style="width: 15px;height: 15px;margin-right: 5px"></a>
        ...
        <div class="dialog-container" id="deleteDialog" style="width: 500px">
            <span id="closeBtn"  onclick="closeDeleteDialog()">&times;</span>
                ...
                <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Add reply!</h1>
                </div>
                <form class="user">

                    <div class="form-floating mb-3">
                        <label for="fileInput" class="text-primary">reply:</label>
                        <textarea class="form-control" id="message" name="question" type="text" placeholder="Enter your reply here..." style="height: 10rem" data-sb-validations="required" required=""></textarea>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn " style="background: #006079;color: white" onclick="deleteItem()" ><img src="img/reply.png" style="width: 15px;height: 15px;">
                        reply</button>
                    </div>
